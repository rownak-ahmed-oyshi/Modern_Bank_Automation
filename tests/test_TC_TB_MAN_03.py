...
@pytest.mark.parametrize(
    "manager_test_case",
    [get_test_case("manager_test_data.json", "valid_manager", 1)]  # index 1 → Rownak Ahmed Oyshi
) #connecting data loader

def test_tc_tb_man_03(browser_config,manager_test_case):
    logging.info("TC_TB_MAN_03 Started..")
    ...
    # Validate Manager Registration Error Message
    ...
    if expected_message == actual_message:
        ...
        capture_full_page_screenshot(driver, "BUG_TC_TB_MAN_03")
