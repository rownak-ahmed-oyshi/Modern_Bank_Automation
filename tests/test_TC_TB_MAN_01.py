...
@pytest.mark.parametrize(
    "manager_test_case",
    [get_test_case("manager_test_data.json", "valid_manager", 0)]  # index 0 → Rownak Ahmed Oyshi
) #connecting data loader

def test_tc_tb_man_01(browser_config,manager_test_case):
    logging.info("TC_TB_MAN_01 Started..")
    ...
    # Validate Manager Registration
    expected_message = manager_test_case["expected_message"]
    actual_message = manager_register_page.get_manager_registered_successful_message()
    ...
    if expected_message == actual_message:
        ...
        capture_full_page_screenshot(driver, "BUG_TC_TB_MAN_01")
